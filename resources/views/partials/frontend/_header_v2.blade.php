            ...
            <div class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu respon-sub-menu left">
                        <li>
                            <a href="{{ route('home')}}#concept" class="text-white font-metropolis let-spa-2 txt-body">CONCEPT</a>
{{--                            <ul class="sub-menu">--}}
    ...
    <nav class="container-header-mobile">
        ...
        <div class="menu-mobile">
            <ul class="main-menu" style="background-color: black;">
                ...
                <li>
                    <a href="{{ route('home')}}#concept" class="text-white font-metropolis txt-body" style="letter-spacing: 2px;">CONCEPT</a>
                </li>
